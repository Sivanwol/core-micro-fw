...
public class Program {
    ...
    public static int Main(string[] args) {
        try {
            ...
            var serviceName = sercetSettings.ServiceName ?? "Backend.api";
            var seqUrl = sercetSettings.SeqUrl ?? "";
            var seqApiKey = sercetSettings.SeqApiKey ?? "";
            SerilogExtension.ProcessLogHandler("Backend.api", _getCurrentEnvironment ??= "development", seqUrl, seqApiKey);
