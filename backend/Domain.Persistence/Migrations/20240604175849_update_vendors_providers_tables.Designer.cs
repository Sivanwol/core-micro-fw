...
namespace Domain.Persistence.Migrations
{
    ...
    [Migration("20240604175849_update_vendors_providers_tables")]
    partial class update_vendors_providers_tables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.ProviderCategory", b =>
                {
                    ...
                    b.HasIndex("UserId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_provider_category_user_id_name");
            ...
            modelBuilder.Entity("Domain.Entities.Providers", b =>
                {
                    ...
                    b.HasIndex("ClientId")
                        .HasDatabaseName("ix_providers_client_id");

                    b.HasIndex("CountryId")
                        .HasDatabaseName("ix_providers_country_id");

                    b.HasIndex("Media")
                        .HasDatabaseName("ix_providers_media");
                    ...
                    b.HasIndex("UserId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_providers_user_id_name");
            ...
            modelBuilder.Entity("Domain.Entities.Vendors", b =>
                {
                    ...
                    b.HasIndex("UserId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_vendors_user_id_name");
            ...
            modelBuilder.Entity("Domain.Entities.ProviderCategory", b =>
                {
                    b.HasOne("Domain.Entities.ApplicationUser", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_provider_category_users_user_id");
            ...
            modelBuilder.Entity("Domain.Entities.Providers", b =>
                {
                    b.HasOne("Domain.Entities.Clients", "Client")
                        .WithMany()
                        .HasForeignKey("ClientId")
                        .HasConstraintName("fk_providers_clients_client_id");
                    ...
                    b.HasOne("Domain.Entities.Media", "Logo")
                        .WithMany()
                        .HasForeignKey("Media")
                        .HasConstraintName("fk_providers_media_media");
