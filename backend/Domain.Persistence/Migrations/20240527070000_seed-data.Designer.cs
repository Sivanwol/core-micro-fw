...
namespace Domain.Persistence.Migrations
{
    ...
    [Migration("20240527070000_seed-data")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ConfigurableUserViewTags", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_configutable_user_view_tags");

                    b.HasIndex("UserId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_configutable_user_view_tags_user_id_name");

                    b.ToTable("configutable-user-view-tags");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ConfigurableUserViewsFilterMacros", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_configutable_user_view_filter_macros");

                    b.ToTable("configutable-user-view-filter-macros");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProviderHasCategories", b =>
                {
                    b.Property<int>("ProviderId")
                        .HasColumnType("integer")
                        .HasColumnName("provider_id");
                    ...
                    b.HasKey("ProviderId", "CategoryId")
                        .HasName("pk_providers_has_categories");

                    b.HasIndex("CategoryId")
                        .HasDatabaseName("ix_providers_has_categories_category_id");

                    b.ToTable("providers_has_categories", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.ConfigurableUserViewTags", b =>
                {
                    b.HasOne("Domain.Entities.ApplicationUser", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_configutable_user_view_tags_users_user_id");
            ...
            modelBuilder.Entity("Domain.Entities.ConfigurableUserViewsFilters", b =>
                {
                    b.HasOne("Domain.Entities.ConfigurableUserViewsFilterMacros", "FilterMacroValue")
                        ...
                        .HasConstraintName("fk_configurable_user_view_filters_configutable_user_view_filte");
            ...
            modelBuilder.Entity("Domain.Entities.ProviderHasCategories", b =>
                {
                    b.HasOne("Domain.Entities.Categories", "Category")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_providers_has_categories_categories_category_id");
                    ...
                    b.HasOne("Domain.Entities.Providers", "Provider")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_providers_has_categories_providers_provider_id");
